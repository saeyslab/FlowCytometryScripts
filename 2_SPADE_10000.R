...
start <- Sys.time()
    ...
    out_dir <- "SPADE_10000"
    SPADE.driver("fcs/21-10-15_Tube_028_selected_10000.fcs",
                 out_dir=out_dir,
...
# used in the paper.
library(FlowSOM)
spade_fcs <- read.FCS(paste0(out_dir,"/21-10-15_Tube_028_selected_10000.fcs.density.fcs.cluster.fcs"))
...
# Save results
save(t_SPADE_10000, spade_res, file="SPADE_10000.Rdata")

# Plot results
pdf("SPADE_10000.pdf",useDingbats = FALSE)
    PlotPies(UpdateNodeSize(spade_res,reset=T),manual[selected][1:10000],
